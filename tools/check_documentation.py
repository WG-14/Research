...
_REQUIRED_DOCUMENTS = (
    ...
    Path("docs/investment-research-platform-audit.json"),
    Path("docs/investment-research-platform-audit-report.md"),
    Path("docs/investment-research-platform-audit-result.json"),
    Path("docs/investment-research-platform-audit-rubric.md"),
    Path("docs/investment-research-platform-audit-instructions.md"),
...
_REQUIRED_COMMAND_REFERENCES = {
    Path("README.md"): (
        ...
        "scripts/platform verify-product-scope",
