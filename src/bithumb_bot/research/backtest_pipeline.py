...
class DefaultRiskGate:
    ...
    def evaluate(
        ...
        if evaluates_exit_policy and strategy_decision is None and not unsupported_reason:
...
class DefaultExecutionSimulator:
    ...
    def execute(self, *args: Any, **kwargs: Any) -> ExecutionSimulationOutcome:
        ...
        plan_bundle = _research_execution_plan_bundle(
            side=action,
        ...
        evidence = _execution_plan_evidence(plan_bundle)
        ...
        if reference.fill_reference_price is None:
            ...
            service = ResearchVirtualExecutionService(execution_model=model, fee_rate=fee_rate)
