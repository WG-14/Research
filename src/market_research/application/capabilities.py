...
CAPABILITIES: tuple[CapabilitySpec, ...] = (
    ...
    _cli(
        ...
        "Build portable classic research package",
        "research.package.export",
        CapabilityExecutionMode.SYNCHRONOUS,
        CapabilityRisk.HIGH,
        GuiPolicy.CLI_ONLY,
        "Builds a deterministic immutable package from a classic result, its receipt, manifest, and licensed content-addressed data contract.",
    ),
    _cli(
        "research-verify-portable-package",
        "Verify portable classic research package",
        "research.audit.verify",
        CapabilityExecutionMode.SYNCHRONOUS,
        CapabilityRisk.MEDIUM,
        GuiPolicy.CLI_ONLY,
        "Verifies every package artifact and exact external dataset requirement without consulting a checkout.",
    ),
    _cli(
        "research-reproduce-portable-package",
        "Reproduce portable classic research package",
        "research.reproduce",
        CapabilityExecutionMode.SYNCHRONOUS,
        CapabilityRisk.HIGH,
        GuiPolicy.CLI_ONLY,
        "Cold-replays a verified classic package through a non-editable installed distribution in an empty external workspace.",
    ),
    _cli(
        "research-compare",
        "Compare reports",
    ...
    _cli(
        ...
        CapabilityRisk.CRITICAL,
        GuiPolicy.ADMIN_ONLY,
        "The public CLI is fail-closed; material lifecycle changes are system-managed or performed by an authenticated internal-web governance workflow.",
    ),
    _cli(
        ...
        CapabilityRisk.HIGH,
        GuiPolicy.ADMIN_ONLY,
        "The public CLI is fail-closed; the authenticated internal-web workflow creates authoritative human-review events from server-derived identity and duties.",
    ...
    _cli(
        ...
        CapabilityRisk.CRITICAL,
        GuiPolicy.ADMIN_ONLY,
        "The public CLI is fail-closed; the authenticated internal-web workflow creates hash-bound approval under durable separation-of-duties controls.",
    ...
    CapabilitySpec(
        ...
        display_name="Record independent research stage",
        permission="research.project.write",
        execution_mode=CapabilityExecutionMode.SYNCHRONOUS,
        risk=CapabilityRisk.HIGH,
        gui_policy=GuiPolicy.REQUIRED,
        service_id="ResearchProjectApplicationService.record_study_stage",
        cli_command=None,
        request_model=ResearchStudyStageRequest,
        result_model=ResearchStudyLifecycleResult,
        reason="Records one independently timed, actor-bound pre-validation lifecycle event.",
    ),
    CapabilitySpec(
        capability_id="research-project-preregister-study",
        display_name="Preregister research study",
        permission="research.project.write",
        execution_mode=CapabilityExecutionMode.SYNCHRONOUS,
        risk=CapabilityRisk.CRITICAL,
        gui_policy=GuiPolicy.REQUIRED,
        service_id="ResearchProjectApplicationService.preregister_study",
        cli_command=None,
        request_model=ResearchStudyPreregistrationRequest,
        result_model=ResearchStudyLifecycleResult,
        reason="Freezes the complete design before confirmatory data access.",
    ),
    CapabilitySpec(
