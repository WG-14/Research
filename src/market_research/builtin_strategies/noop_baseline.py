...
from market_research.research.strategy_spec import NOOP_BASELINE_SPEC, materialize_strategy_parameters
from market_research.research.strategies.noop_baseline_events import build_noop_baseline_events
...
def _materialize(*, plugin: ResearchStrategyPlugin, parameter_values: dict[str, Any], fee_rate: float,
    ...
    del plugin, context
    return materialize_strategy_parameters("noop_baseline", parameter_values,
