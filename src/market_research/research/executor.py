...
def _worker_process_evidence(result: ResearchWorkResult) -> dict[str, Any]:
    ...
    return {
        ...
        "callable_identity": "market_research.research.validation_protocol._candidate_scenario_worker",
        "command_or_callable_identity": "market_research.research.validation_protocol._candidate_scenario_worker",
