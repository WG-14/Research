...
def run_decision_event_backtest(*, strategy_name: str, strategy_registry: Any, **kwargs: Any) -> Any:
    ...
    return run_common_simulation_backtest(plugin=plugin, registry=strategy_registry, dataset=kwargs["dataset"],
