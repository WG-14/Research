...
def _build_trade_return_panel(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "missing_observation_policy": DEFAULT_MISSING_OBSERVATION_POLICY,
        "attempted_statistical_evidence_return_unit": STATISTICAL_EVIDENCE_RETURN_UNIT,
        "limitations": [
        ...
        "official_statistical_evidence_wrc_generation_available": False,
        "statistical_evidence_fail_reasons": [
        ...
        "operator_next_step": (
            ...
            "with an official statistical-evidence WRC implementation bound to that panel"
        ),
    }
    ...
    *,
    ...
    for candidate in sorted(
        ...
        row_metadata = {
            ...
            "parameter_values": candidate.get("parameter_values") or {},
            "scenario_ids": _candidate_scenario_ids(candidate),
            "return_unit": STATISTICAL_EVIDENCE_RETURN_UNIT,
            "benchmark": benchmark,
            "split": split,
    ...
    payload: dict[str, Any] = {
        ...
        **metadata,
        ...
        "official_statistical_evidence_wrc_generation_available": True,
        "statistical_evidence_fail_reasons": [],
...
def _return_panel_series_reasons(panel: dict[str, Any]) -> list[str]:
    ...
    if parsed_ordered_index != sorted(union_index):
        reasons.append("return_panel_time_index_mismatch")
    if panel.get("statistical_evidence_available") is True:
        for row in rows:
            if not isinstance(row, dict):
                continue
