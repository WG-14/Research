...
def _attach_participation_summary(summary: dict[str, Any], candidate: dict[str, Any]) -> None:
    ...
    compact_keys = (
        ...
        "fallback_submit_expected_count",
        "fallback_submitted_count",
        "fallback_filled_count",
        "fallback_closed_trade_count",
        "base_sma_buy_count",
        "daily_counts_hash",
        "not_a_fill_guarantee",
    )
...
def _compact_derived_candidate_large_blocks(summary: dict[str, Any]) -> None:
    ...
    capabilities = summary.pop("research_strategy_contract", None)
...
def summarize_candidate_result(candidate: Any, report_detail: str) -> Any:
    ...
    summary_keys = (
        ...
        "execution_calibration_policy_reasons",
...
def _compact_candidate_artifact_summary(summary: dict[str, Any]) -> None:
    ...
    if "execution_calibration_policy_result" in summary:
        summary["execution_calibration_policy_result"] = _compact_status_payload(
            summary["execution_calibration_policy_result"],
            hash_key="execution_calibration_policy_hash",
        )
