...
class DefaultStrategyEvaluator:
    ...
    Validation-grade decisions must carry StrategyDecisionService.evaluate provenance.
    """
    ...
    def evaluate(
        ...
        statistical_evidence_policy_required = policy_materialization_mode != "research_exploratory"
        ...
        if statistical_evidence_policy_required and policy_decision is None:
        ...
        if policy_decision is not None:
            ...
            if statistical_evidence_policy_required and missing:
                raise ValueError("research_strategy_decision_validation_fields_missing:" + ",".join(missing))
        ...
        provenance = {
            ...
            "research_comparable": bool(policy_materialization_mode != "research_exploratory" and policy_decision is not None),
            "statistical_evidence_policy_required": statistical_evidence_policy_required,
        ...
        return StrategyEvaluationEnvelope(
            ...
            compatibility_fallback=policy_decision is None,
            statistical_evidence=bool(policy_decision is not None and not unsupported_reason),
