...
from bithumb_research.market_regime import classify_market_regime_from_arrays
...
def feature_provider_for_name(name: str) -> FeatureProvider:
    from bithumb_research.research.feature_provider_registry import feature_provider_spec_for_name

    return feature_provider_spec_for_name(name).provider


def feature_providers_for_names(names: tuple[str, ...]) -> tuple[FeatureProvider, ...]:
    from bithumb_research.research.feature_provider_registry import feature_provider_specs_for_names
