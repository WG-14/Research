...
VALIDATION_EXECUTION_TIMING_REQUIRED_FIELDS = (
...
def evaluate_execution_reality_policy(
    *,
    ...
    """Evaluate execution timing invariants at a validation trust boundary."""
    ...
    result: dict[str, Any] = {
        ...
        "reasons": [],
        "required_fields": list(VALIDATION_EXECUTION_TIMING_REQUIRED_FIELDS),
    ...
    missing_required_fields = [
        field
        for field in VALIDATION_EXECUTION_TIMING_REQUIRED_FIELDS
    ...
    if fill_policy in {"first_orderbook_after_decision", "latency_adjusted_orderbook"}:
        ...
        if top is None or not bool(_field_value(top, "required")):
            reasons.append("validation_top_of_book_required")
        if top is not None:
            if _field_value(top, "missing_policy") != "fail":
                reasons.append("validation_missing_quote_policy_must_fail")
            if float(_field_value(top, "min_coverage_pct") or 0.0) < 100.0:
                reasons.append("validation_top_of_book_min_coverage_must_be_100")
...
def build_execution_reality_contract(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "min_execution_reality_level_for_validation": min_execution_reality_level_for_validation,
...
def build_execution_capability_contract(
    *,
    ...
    payload = {
        ...
        "validation_rule": "fail_closed_if_required_capability_unavailable",
