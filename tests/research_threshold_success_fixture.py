...
PRICES = (99.0, 100.0, 101.0, 102.0, 98.0, 105.0)
THRESHOLD = 100.0
...
def create_success_fixture(root: Path) -> tuple[Path, Path]:
    ...
    manifest = {
        "experiment_id": "threshold_success_import_boundary",
        "hypothesis": "deterministic research-native threshold fixture",
        ...
        "parameter_space": {"THRESHOLD_CLOSE_ABOVE": [THRESHOLD]},
