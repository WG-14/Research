...
def _typed_payload(**overrides: object) -> dict[str, object]:
    payload = PromotionArtifact.create_from_typed_bundle(
        canonical_decision_v2={
            ...
            "decision_input_contract_hash": HASH,
            "decision_input_bundle_payload_hash": HASH,
            "market_snapshot_hash": HASH,
            "market_feature_hash": HASH,
            "position_snapshot_hash": HASH,
            "execution_constraints_hash": HASH,
            "policy_config_hash": HASH,
            "exit_policy_config_hash": HASH,
            "fee_authority_hash": HASH,
            "order_rules_hash": HASH,
