...
def test_custom_strategy_specific_backtest_runner_is_rejected():
    with pytest.raises(ValueError, match="custom_execution_authority_rejected"):
        ResearchStrategyPlugin(name="fixture", version="1", spec=SMA_WITH_FILTER_SPEC, required_data=("candles",), optional_data=(), event_builder=lambda **kwargs: (), decision_contract_version="v1", diagnostics_namespace="fixture", execution_authority="custom_runner")
