...
def test_sma_signal_stream_preserved_after_engine_migration() -> None:
    ...
    data = DatasetSnapshot(
        ...
        tuple(Candle(i * 60_000, p, p, p, p, 1) for i, p in enumerate(prices)),
    )
    result = run_common_simulation_backtest(
        ...
        parameter_values={
            "SMA_SHORT": 2,
            "SMA_LONG": 3,
            "SMA_FILTER_GAP_MIN_RATIO": 0,
            "SMA_FILTER_VOL_MIN_RANGE_RATIO": 0,
            "SMA_FILTER_OVEREXT_MAX_RETURN_RATIO": 1,
