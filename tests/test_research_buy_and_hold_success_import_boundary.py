...
"""
    ...
    report = root / "artifacts" / "reports" / "research" / "buy_and_hold_success_import_boundary" / "backtest_report.json"
    ...
    assert validation["validation_resource_usage"]["buy_and_hold_research_kernel"] == "research_only_v1"
