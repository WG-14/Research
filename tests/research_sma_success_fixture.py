...
def create_success_fixture(root: Path) -> tuple[Path, Path]:
    ...
    manifest = {
        ...
        "acceptance_gate": {"min_trade_count": 1, "max_mdd_pct": 100, "min_profit_factor": 0.1, "oos_return_must_be_positive": False, "parameter_stability_required": False, "walk_forward_required": False, "final_holdout_required_for_promotion": False, "reject_open_position_at_end": False, "metrics_contract_required": False},
