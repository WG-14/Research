...
def _metric() -> FeatureBucketMetric:
    return FeatureBucketMetric(
        ...
        sample_start_ts=1,
        sample_end_ts=1,
        mean_gross_forward_return=0.01,
        median_gross_forward_return=0.01,
        win_rate=1.0,
        p10_gross_forward_return=0.01,
        p90_gross_forward_return=0.01,
        mean_mfe=0.02,
        median_mfe=0.02,
        mean_mae=-0.01,
        median_mae=-0.01,
    ...
    return ForwardDiagnosticsResult(
        ...
        dataset_quality=ForwardDiagnosticsDatasetQuality(
            ...
            dataset_quality_report_payload={
                ...
                "canonical_snapshot_hash": "sha256:" + "2" * 64,
