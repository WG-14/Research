...
Also review `statistical_validation_required`, `statistical_parameter_grid_size`, `statistical_search_budget`, `statistical_attempt_index`, `statistical_holdout_reuse_count`, `selection_universe_hash`, `statistical_evidence_hash`, `white_reality_check_p_value`, `statistical_gate_result`, and `statistical_gate_fail_reasons`. These fields are not cosmetic; production-bound promotion refuses missing, mismatched, or failed statistical evidence.
...
jq '{required: .statistical_validation_required, universe: .selection_universe_hash, evidence: .statistical_evidence_hash, p: .white_reality_check_p_value, gate: .statistical_gate_result, reasons: .statistical_gate_fail_reasons}' "$DATA_ROOT/paper/reports/research/sma_filter_v1_2026_05/backtest_report.json"
